...
from data_juicer.core.optimizer.op_pruning_strategy import OpPruningStrategy
...
class PipelineOptimizer:
    ...
    def __init__(
        ...
        if strategies is None:
            ...
            self.strategies = [
                OpPruningStrategy(),  # Prune no-op/duplicate ops first
                OpReorderStrategy(),  # Then reorder remaining ops
