...
class VideoHandReconstructionHaworMapper(Mapper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        LazyLoader.check_packages(["lap", "pytorch_lightning", "yacs", "scikit-image", "timm", "omegaconf"])
    ...
    def detect_track(self, imgfiles: list, hand_det_model: ultralytics.YOLO, thresh: float = 0.5) -> tuple:
        """
