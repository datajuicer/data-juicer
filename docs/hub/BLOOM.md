...
## Oscar
The raw data files can be downloaded as described in [BLOOM/Oscar](https://github.com/bigscience-workshop/data-preparation/tree/main/preprocessing/training/01b_oscar_cleaning_and_filtering). Then use [bloom-oscar.yaml](../../configs/reproduced_bloom/bloom-oscar.yaml) to perform the whole processing.
